...
export default function AdminDashboard() {
  ...
  return (
    <AdminProtected>
      {/* Container is flex-col so that the footer can sit at the bottom of the stack */}
      <div className="flex flex-col min-h-screen bg-white">
        
        {/* Main Dashboard Body */}
        <div className="flex flex-1">
          
          {/* --- LEFT SIDEBAR: Changed to sticky to respect page flow --- */}
          <aside className="w-[300px] border-r border-slate-100 p-10 flex flex-col sticky top-0 h-screen bg-white overflow-y-auto">
            <div className="mb-16">
          ...
          {/* --- MAIN CONTENT AREA: Removed ml-[300px] --- */}
        ...
        {/* The footer in the Root Layout will now sit here automatically, 
            spanning 100% of the width because the flex container above 
            is finished. */}
      </div>
    </AdminProtected>
  );
